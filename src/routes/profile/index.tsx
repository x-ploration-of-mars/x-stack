        ...
        <div class="lg:pl-24">
          <div class="space-y-12">
            <div class="grid grid-cols-1  gap-x-8 gap-y-10 border-b border-primary/10 pb-12 md:grid-cols-3">
              <div>
                <h2 class=" text font-semibold leading-7 text-primary">About you</h2>
                <p class="mt-1 leading-6 text-muted-foreground">
                  Fill out this form to network with fellow x-plorers. You will have to fill
                  required fields to appear in search results.
                </p>
              </div>

              {/*TODO: Location (country!, region?, city?), Favorite techs (top 5 / top 10 / top 50 ?) */}

              <div class="grid max-w-xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
